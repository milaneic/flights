    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{URL('/')}}">
                ...
                <div class="sidebar-brand-text mx-3">Flights Admin <sup>2</sup></div>
            </a>
            ...
            <x-admin.sidebar.flights-links></x-admin.sidebar.flights-links>
            ...
            <x-admin.sidebar.baggages-links></x-admin.sidebar.baggages-links>
