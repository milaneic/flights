                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            <li><a class="active" href="{{route('flights.index')}}">home</a></li>
                            ...
                            <div class="col-xl-6 col-lg-6 d-none d-lg-block">
                                <div class="social_wrap d-flex align-items-center justify-content-end">
                                    <div class="number">
                                        <p> <i class="fa fa-phone"></i> +(381) 11 240 680</p>
                                    </div>
                                    <div class="social_links d-none d-xl-block">
                                        <ul>
                                            <li><a href="{{URL('//www.instagram.com')}}"> <i
                                                        class="fa fa-instagram"></i>
                                                </a></li>
                                            <li><a href="{{URL('//www.linkedin.com')}}"> <i class="fa fa-linkedin"></i>
                                                </a></li>
                                            <li><a href="{{URL('//www.facebook.com')}}"> <i class="fa fa-facebook"></i>
                                                </a></li>
                                            <li><a href="{{URL('//www.google.com')}}"> <i class="fa fa-google-plus"></i>
                                                </a></li>
                                            @guest
                                            <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Italy <a href="travel_destination.html"> 07 Places</a>
                            </p>
